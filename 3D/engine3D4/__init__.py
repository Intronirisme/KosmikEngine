...
class model:
	def __init__(self, pos, orient, lsVertex, lsFace, WF=False):
		...
		self.lsFace = []
		for faces in lsFace:
			normal, lsIndexVertex, color = faces #((0,0,1), [0,2,3], [(255,0,0), (0, 148, 200), (120, 35, 148)])  par exemple
			self.lsFace.append(face(normal, lsIndexVertex, color, self.WF))
...
class face:
	def __init__(self, normal, lsVertex, lsColor, WF=False):
